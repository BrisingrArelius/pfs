...
|---:|---|---|---|
| 301 | hdd | `/mnt/hdd1` | `/dev/sda1` |
| 302 | hdd | `/mnt/hdd2` | `/dev/sdb1` |
| 303 | hdd | `/mnt/hdd3` | `/dev/sdc1` |
| 304 | hdd | `/mnt/hdd4` | `/dev/sdd1` |
| 305 | nvme | `/mnt/nvme1` | `/dev/nvme1n1p1` |
| 306 | nvme | `/mnt/nvme2` | `/dev/nvme2n1p1` |
| 307 | nvme | `/mnt/nvme3` | `/dev/nvme3n1p1` |
