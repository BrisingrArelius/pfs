# Historical workload results

- `darshan/` preserves the original root `output/` tree: HDD/SSD global CSVs,
  analysis figures/statistics and cross-pool comparisons.
- `execution/from-logs/` preserves checkpoints and errors from the former
  `logs_and_checkpoints/` directory.
