...
> Historical research record. Paths, pool IDs, inventory and causal explanations
> below reflect earlier investigations, not a verified current cluster state.
> The current experiment uses D/S/H with randomized/roundrobin; see
