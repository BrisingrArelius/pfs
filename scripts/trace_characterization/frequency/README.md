...
the selected output directory: `rate_active_distribution[_minops20].png`,
...
[the literature review](../../../docs/research/LitReview_task1.md)),
parallel in method to Part D's contiguous-ratio analysis in
[contiguity analysis](../contiguity/README.md). This directory is
...
- `results/trace_analysis/legacy/frequency/` (from repository root) — preserved CSVs and PNGs.
